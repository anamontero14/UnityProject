...
namespace Sample
{
        ...
        private Dictionary<int, bool> PlayerStatus = new Dictionary<int, bool>
    {
        ...
        private void Damage()
        {
            // Sin tecla asignada por ahora
            // La animación de daño se puede activar desde otro script cuando sea necesario
        }
        //---------------------------------------------------------------------
        // respawn
        //---------------------------------------------------------------------
